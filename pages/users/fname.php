    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3>จัดการ คำนำหน้าชื่อ</h3>
            </div>
            <div class="page-content" id="usersFname" v-cloak>
                <section class="row">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            ...
                                            <div>
                                                <button class="btn btn-success btn-md" @click="fname_insert()">เพิ่ม</button>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr v-for="d,index in datas">
                                                    ...
                                                    <td>
                                                        <button class="btn btn-warning btn-sm me-2 mb-1" @click="fname_update(d.id)">แก้ไข</button>    
                                                        <button class="btn btn-danger btn-sm me-2 mb-1" @click="fname_del(d.id)">ลบ</button>    
                ...
                <div class="modal fade" id="staticBackdrop_form" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form @submit.prevent="fname_save">
